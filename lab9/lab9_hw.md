...
```
## # A tibble: 161 x 3
## # Groups:   stabbr, city [161]
##    stabbr city                avg_cost
##    <chr>  <chr>                  <dbl>
##  1 CA     Claremont              66498
##  2 CA     Malibu                 66152
##  3 CA     Valencia               64686
##  4 CA     Orange                 64501
##  5 CA     Redlands               61542
##  6 CA     Moraga                 61095
##  7 CA     Atherton               56035
##  8 CA     Thousand Oaks          54373
##  9 CA     Rancho Palos Verdes    50758
## 10 CA     La Verne               50603
## # ... with 151 more rows
```
<style>
...
## 
## data:  table(colleges$costt4_a, colleges$c150_4_pooled)
## X-squared = NaN, df = 24840, p-value = NA
```
