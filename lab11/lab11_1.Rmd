...
```{r}
customaes <- ggplot(homerange, aes(x = log10.hra))
customaes + geom_histogram(aes(y = ..density..), binwidth = .3, fill = 'cyan', color = 'black', alpha = .7) + labs(title = 'Distribution of Heart Rate')
```

2. Now plot the same variable using `geom_density()`.
```{r}
customaes + geom_density(color = 'red') + labs(title = 'Distribution of Heart Rate')
```

3. Combine them both!
```{r}
customaes + geom_histogram(aes(y = ..density..), binwidth = .3, fill = 'cyan', color = 'black', alpha = .7) + geom_density(color = 'red') + labs(title = 'Distribution of Heart Rate')
```
